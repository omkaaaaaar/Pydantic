...
class Patient(BaseModel):
    ...
    weight: Annotated[float, Field(gt=0, strict=True)] #here we are using Annotated to provide additional metadata for the weight field, gt is used to validate that weight should be greater than 0, strict is used to ensure that the value provided for weight is of type float
